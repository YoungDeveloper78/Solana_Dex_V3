...
use crate::{manager::swap_manager::PostSwapUpdate, state::Pool};

use super::{transfer_from_owner_to_vault_v2, transfer_from_vault_to_owner_v2};

pub fn update_and_swap_pool_v2<'info>(
...
pub fn update_and_two_hop_swap_pool_v2<'info>(
    // update
    swap_update_one: PostSwapUpdate,
    swap_update_two: PostSwapUpdate,
    // pool
    pool_one: &mut Account<'info, Pool>,
    pool_two: &mut Account<'info, Pool>,
    // direction
