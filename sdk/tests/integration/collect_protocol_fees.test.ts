...
import { PDAUtil, toTx, WhirlpoolContext, PoolData, WhirlpoolIx } from "../../src";
...
describe("collect_protocol_fees", () => {
  ...
  it("successfully collects fees", async () => {
    ...
    const poolBefore = (await fetcher.getPool(whirlpoolPda.publicKey, IGNORE_CACHE)) as PoolData;
    ...
    const poolAfter = (await fetcher.getPool(whirlpoolPda.publicKey, IGNORE_CACHE)) as PoolData;
