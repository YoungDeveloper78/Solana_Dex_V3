...
describe("set_default_fee_rate", () => {
  ...
  it("successfully set_default_fee_rate", async () => {
    ...
    let whirlpool_0 = (await fetcher.getPool(whirlpoolKey)) as PoolData;
    ...
    whirlpool_0 = (await fetcher.getPool(poolInitInfo.whirlpoolPda.publicKey)) as PoolData;
    assert.equal(whirlpool_0.feeRate, feeTierParams.defaultFeeRate);
    ...
    const whirlpool_1 = (await fetcher.getPool(whirlpoolPda.publicKey)) as PoolData;
