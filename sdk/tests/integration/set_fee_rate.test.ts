...
import { toTx, WhirlpoolContext, PoolData, WhirlpoolIx } from "../../src";
...
describe("set_fee_rate", () => {
  ...
  it("successfully sets_fee_rate", async () => {
    ...
    let whirlpool = (await fetcher.getPool(whirlpoolKey, IGNORE_CACHE)) as PoolData;
    ...
    whirlpool = (await fetcher.getPool(poolInitInfo.whirlpoolPda.publicKey, IGNORE_CACHE)) as PoolData;
