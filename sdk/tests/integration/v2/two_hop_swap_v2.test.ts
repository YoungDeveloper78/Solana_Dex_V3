...
describe("two_hop_swap_v2", () => {
  ...
  describe("v1 parity", () => {
    ...
    */
          ...
          //const postWhirlpoolDataTwo = await fetcher.getPool(whirlpoolTwoKey, IGNORE_CACHE) as PoolData;
  ...
  describe("v2 specific accounts", () => {
    describe("with Token-2022", () => {
      ...
      beforeEach(async () => {
        otherTokenPublicKey = await createMintV2(provider, { isToken2022: true });
    ...
    describe("with Token", () => {
      ...
      beforeEach(async () => {
        otherTokenPublicKey = await createMintV2(provider, { isToken2022: false });
