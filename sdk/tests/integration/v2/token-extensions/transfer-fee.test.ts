...
describe("TokenExtension/TransferFee", () => {
  ...
  describe("collect_reward_v2", () => {
    ...
    beforeEach(async () => {
      ...
      const whirlpoolData = (await fetcher.getPool(whirlpoolPda.publicKey)) as PoolData;
  ...
  describe("two_hop_swap", () => {
    ...
    let whirlpoolDataOne: PoolData;
    let whirlpoolDataTwo: PoolData;
  ...
  describe("Special cases", () => {
    ...
    describe("use current fee rate even if next fee rate exists", () => {
      it("owner to vault", async () => {
        ...
        let whirlpoolData = (await fetcher.getPool(whirlpoolPubkey, IGNORE_CACHE)) as PoolData;
    ...
    describe("use updated fee rate once epoch comes", () => {
      it("owner to vault", async () => {
        ...
        for (let i = 0; i < newBpsList.length; i++) {
          ...
          const whirlpoolData = (await fetcher.getPool(whirlpoolPubkey, IGNORE_CACHE)) as PoolData;
