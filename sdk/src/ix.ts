...
export class WhirlpoolIx {
   ...
   */
  public static initializeConfigIx(program: Program<AnchorDex>, params: ix.InitConfigParams) {
   ...
   * @returns - Instruction to perform the action.
   */
  public static initializeFeeTierIx(program: Program<AnchorDex>, params: ix.InitFeeTierParams) {
   ...
   * @returns - Instruction to perform the action.
   */
  public static initializePoolIx(program: Program<AnchorDex>, params: ix.InitPoolParams) {
    return ix.initializePoolIx(program, params);
  }

  /**
   * Initialize reward for a AnchorDex. A pool can only support up to a set number of rewards.
   ...
   * @returns - Instruction to perform the action.
   */
  public static initializeRewardIx(program: Program<AnchorDex>, params: ix.InitializeRewardParams) {
   ...
   * @returns - Instruction to perform the action.
   */
  public static initTickArrayIx(program: Program<AnchorDex>, params: ix.InitTickArrayParams) {
    return ix.initTickArrayIx(program, params);
  }

  /**
   * Open a position in a AnchorDex. A unique token will be minted to represent the position in the users wallet.
   ...
   * @returns - Instruction to perform the action.
   */
  public static openPositionIx(program: Program<AnchorDex>, params: ix.OpenPositionParams) {
    return ix.openPositionIx(program, params);
  }

  /**
   * Open a position in a AnchorDex. A unique token will be minted to represent the position
  ...
  /**
   * Add liquidity to a position in the AnchorDex. This call also updates the position's accrued fees and rewards.
   *
   * #### Special Errors
  ...
  /**
   * Remove liquidity to a position in the AnchorDex. This call also updates the position's accrued fees and rewards.
   *
   * #### Special Errors
   * - `LiquidityZero` - Provided liquidity amount is zero.
   * - `LiquidityTooHigh` - Provided liquidity exceeds u128::max.
   ...
   * @returns - Instruction to perform the action.
   */
  public static closePositionIx(program: Program<AnchorDex>, params: ix.ClosePositionParams) {
   ...
   * @returns - Instruction to perform the action.
   */
  public static swapIx(program: Program<AnchorDex>, params: ix.SwapParams) {
    return ix.swapIx(program, params);
  }

  /**
   * Perform a two-hop-swap in this AnchorDex
   *
   * #### Special Errors
   * - `ZeroTradableAmount` - User provided parameter `amount` is 0.
   * - `InvalidSqrtPriceLimitDirection` - User provided parameter `sqrt_price_limit` does not match the direction of the trade.
   ...
   * @returns - Instruction to perform the action.
   */
  public static twoHopSwapIx(program: Program<AnchorDex>, params: ix.TwoHopSwapParams) {
   ...
   * @returns - Instruction to perform the action.
   */
  public static collectFeesIx(program: Program<AnchorDex>, params: ix.CollectFeesParams) {
    return ix.collectFeesIx(program, params);
  }

  /**
   * Collect protocol fees accrued in this AnchorDex.
   *
   * @param program - program object containing services required to generate the instruction
   ...
   * @returns - Instruction to perform the action.
   */
  public static collectRewardIx(program: Program<AnchorDex>, params: ix.CollectRewardParams) {
   ...
   * @returns - Instruction to perform the action.
   */
  public static setFeeAuthorityIx(program: Program<AnchorDex>, params: ix.SetFeeAuthorityParams) {
    return ix.setFeeAuthorityIx(program, params);
  }

  /**
   * Sets the fee rate for a AnchorDex.
   * Only the current fee authority has permission to invoke this instruction.
   *
   * #### Special Errors
   ...
   * @returns - Instruction to perform the action.
   */
  public static setFeeRateIx(program: Program<AnchorDex>, params: ix.SetFeeRateParams) {
    return ix.setFeeRateIx(program, params);
  }

  /**
   * Sets the protocol fee rate for a AnchorDex.
   * Only the current fee authority has permission to invoke this instruction.
   *
   * #### Special Errors
   * - `ProtocolFeeRateMaxExceeded` - If the provided default_protocol_fee_rate exceeds MAX_PROTOCOL_FEE_RATE.
  ...
  /**
   * Set the reward emissions for a reward in a AnchorDex.
   *
   * #### Special Errors
  ...
  /**
   * Open a bundled position in a AnchorDex.
  ...
  /**
   * Close a bundled position in a AnchorDex.
   *
   * #### Special Errors
   * `InvalidBundleIndex` - If the provided bundle index is out of bounds.
