...
/**
 * Parameters to initialize a rewards for a AnchorDex
 *
 ...
 * @param rewardAuthority - Assigned authority by the reward_super_authority for the specified reward-index in this AnchorDex
