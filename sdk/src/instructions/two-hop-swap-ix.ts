...
/**
 * Parameters to execute a two-hop swap on a AnchorDex.
 *
...
/**
 * Parameters that define a two-hop swap on a AnchorDex.
 *
 * @category Instruction Types
 ...
 * @param tickArrayOne0 - PublicKey of the tick-array of swap-One where the AnchorDex's currentTickIndex resides in
 ...
 * @param tickArrayTwo0 - PublicKey of the tick-array of swap-Two where the AnchorDex's currentTickIndex resides in
 ...
 */
export function twoHopSwapIx(program: Program<AnchorDex>, params: TwoHopSwapParams): Instruction {
  const {
    amount,
  ...
  const ix = program.instruction.twoHopSwap(
    ...
    sqrtPriceLimitTwo,
    {
      accounts: {
        ...
        tokenAuthority,
    poolOne:    whirlpoolOne,
      poolTwo:  whirlpoolTwo,
        tokenOwnerAccountOneA,
        tokenVaultOneA,
        tokenOwnerAccountOneB,
        tokenVaultOneB,
