...
export class SwapUtils {
  ...
  /**
   * Given the intended token mint to swap, return the swap direction of a swap for a AnchorDex
   * @param pool The AnchorDex to evaluate the mint against
   ...
   *
   * @category AnchorDex Utils
   * @param tickCurrentIndex - The current tickIndex for the AnchorDex to swap on.
   * @param tickSpacing - The tickSpacing for the AnchorDex.
   * @param aToB - The direction of the trade.
   * @param programId - The AnchorDex programId which the AnchorDex lives on.
  ...
  /**
   * Convert a quote object and WhirlpoolClient's {@link AnchorDex} object into a {@link SwapParams} type
   ...
   * @param whirlpool - A {@link AnchorDex} object from WhirlpoolClient
