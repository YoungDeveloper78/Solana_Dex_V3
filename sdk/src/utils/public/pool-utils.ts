...
import { PoolData, WhirlpoolRewardInfoData } from "../../types/public";
...
export class PoolUtil {
  ...
  public static isRewardInitialized(rewardInfo: WhirlpoolRewardInfoData | null | undefined): boolean {
    if (!rewardInfo) {
      return false;
    }
  ...
  /**
   * Return the corresponding token type (TokenA/B) for this mint key for a AnchorDex.
   *
   ...
   */
  public static getTokenType(pool: PoolData, mint: PublicKey): TokenType | undefined {
   ...
   *
   * @category AnchorDex Utils
   * @param currTick - AnchorDex's current tick index (aka price)
