...
import {  WhirlpoolAccountFetchOptions, WhirlpoolAccountFetcherInterface, PoolData } from "../../index";
...
export class TokenExtensionUtil {
  ...
  public static async getExtraAccountMetasForTransferHook(
    ...
    await addExtraAccountMetasForExecute(
      ...
      destination,
      owner,
      BigInt(0), // extra account must not depend on the amount (the amount will be changed due to slippage)
      "confirmed"
    );
  ...
  public static isV2IxRequiredPool(
    ...
    return tokenExtensionCtx.tokenMintWithProgramA.tokenProgram==(TOKEN_2022_PROGRAM_ID)
      || tokenExtensionCtx.tokenMintWithProgramB.tokenProgram==(TOKEN_2022_PROGRAM_ID);
  }
  ...
  public static isV2IxRequiredReward(
    ...
    return tokenExtensionCtx.rewardTokenMintsWithProgram[rewardIndex]?.tokenProgram==(TOKEN_2022_PROGRAM_ID) ?? false;
  }
}
