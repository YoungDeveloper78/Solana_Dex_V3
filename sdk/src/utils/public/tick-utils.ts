...
export class TickUtil {
   ...
   * @param tickSpacing The tickSpacing for the AnchorDex that this tickArray belongs to
  ...
  /**
   * Check if the tick range is the full range of the AnchorDex.
   * @param tickSpacing The tickSpacing for the AnchorDex
   * @param tickLowerIndex The lower tick index of the range
   * @param tickUpperIndex The upper tick index of the range
   * @returns true if the range is the full range of the AnchorDex, false otherwise.
   */
...
export class TickArrayUtil {
   ...
   * @param whirlpoolAddress - Address for the AnchorDex for these tick-arrays
