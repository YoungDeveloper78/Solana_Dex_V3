 ...
 * @param programId The public key of the AnchorDex Program account that you want to search Whirlpools for.
 ...
 *
 * @category PriceModule
 * @param amountOut The token amount in terms of the first quote token amount to evaluate a AnchorDex's liquidity against.
 * @param priceImpactThreshold Using amountOut to perform a swap quote on a pool, this value is the maximum price impact
 *                             that a AnchorDex can have to be included in the price calculation.
 */
 ...
 *
 * @category PriceModule
 * @param poolMap A map of {@link PoolData} accounts that are used for price calculations.
...
/**
 * A map of whirlpool addresses against {@link PoolData} accounts
 * @category PriceModule
 */
export type PoolMap = Record<string, PoolData>;
