...
import { AnchorDex as AnchorDexTs} from "./artifacts/whirlpool";
import AnchorDex from "./artifacts/whirlpool.json";
...
export class WhirlpoolContext {
  ...
  readonly program: Program<AnchorDexTs>;
  ...
  public static from(
    ...
    const program = new Program(AnchorDex as Idl, programId, anchorProvider);
  ...
  public static withProvider(
    ...
    const program = new Program(AnchorDex as Idl, programId, provider);
    return new WhirlpoolContext(
      provider,
      provider.wallet,
      program,
  ...
  public constructor(
    ...
    this.program = program as unknown as Program<AnchorDexTs>;
