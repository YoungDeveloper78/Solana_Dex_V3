...
export interface WhirlpoolAccountFetcherInterface {
  ...
  /**
   * Fetch and cache the account for a given AnchorDex addresses
   * @param address The mint address
   * @param opts {@link WhirlpoolAccountFetchOptions} instance to dictate fetch behavior
   */
  getPool(address: Address, opts?: WhirlpoolAccountFetchOptions): Promise<PoolData | null>;

  /**
   * Fetch and cache the accounts for a given array of AnchorDex addresses
  ...
  ): Promise<ReadonlyMap<string, PoolData | null>>;
