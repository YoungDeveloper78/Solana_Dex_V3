...
/**
 * Helper class to help interact with AnchorDex Accounts with a simpler interface.
 *
...
export interface WhirlpoolClient {
  ...
  /**
   * Get an WhirlpoolAccountCacheInterface to fetch and cache AnchorDex accounts
   ...
   * @param poolAddresses the addresses of the AnchorDex account addresses to route through
  ...
  /**
   * Get a AnchorDex object to interact with the AnchorDex account at the given address.
   * @param poolAddress the address of the AnchorDex account
   * @param opts an options object to define fetch and cache options when accessing on-chain accounts
   * @return a AnchorDex object to interact with
   */
  getPool: (poolAddress: Address, opts?: WhirlpoolAccountFetchOptions) => Promise<AnchorDex>;

  /**
   * Get a list of AnchorDex objects matching the provided list of addresses.
   * @param poolAddresses the addresses of the AnchorDex accounts
   * @param opts an options object to define fetch and cache options when accessing on-chain accounts
   * @return a list of AnchorDex objects to interact with
   */
  getPools: (poolAddresses: Address[], opts?: WhirlpoolAccountFetchOptions) => Promise<AnchorDex[]>;
  ...
  /**
   * Create a AnchorDex account for a group of token A, token B and tick spacing
   ...
   * @param poolAddresses the addresses of the AnchorDex accounts to collect protocol fees from
...
/**
 * Helper class to interact with a AnchorDex account and build complex transactions.
 * @category WhirlpoolClient
 */
export interface AnchorDex {
  /**
   * Return the address for this AnchorDex instance.
   * @return the PublicKey for this AnchorDex instance.
   */
  getAddress: () => PublicKey;

  /**
   * Return the most recently fetched AnchorDex account data.
   * @return most recently fetched PoolData for this address.
   */
  getData: () => PoolData;

  /**
   * Fetch and return the most recently fetched AnchorDex account data.
   * @return the most up to date PoolData for this address.
   */
  refreshData: () => Promise<PoolData>;
  ...
  /**
   * Open and fund a position on this AnchorDex.
   *
  ...
  /**
   * Open and fund a position with meta-data on this AnchorDex.
   *
   * User has to ensure the TickArray for tickLower and tickUpper has been initialized prior to calling this function.
   *
...
export interface Position {
  ...
  /**
   * Return the most recently fetched AnchorDex account data for this position.
   * @return most recently fetched PoolData for this position.
   */
  getWhirlpoolData: () => PoolData;
