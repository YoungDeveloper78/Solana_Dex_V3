...
import { TickArray, PoolData } from "../../types/public";
 ...
 * @param estimatedEndTickIndex - Approximate tick-index the AnchorDex will land on after this swap
 * @param estimatedEndSqrtPrice - Approximate sqrtPrice the AnchorDex will land on after this swap
 ...
 *
 * @category Quotes
 * @param whirlpool - AnchorDex to perform the swap on
 ...
 * @param programId - PublicKey for the AnchorDex ProgramId
