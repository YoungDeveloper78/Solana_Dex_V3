 ...
 * @param tokenMintA - The mint of tokenA in the AnchorDex the user is depositing into.
 * @param tokenMintB -The mint of tokenB in the AnchorDex the user is depositing into.
 * @param tickCurrentIndex - The AnchorDex's current tickIndex
 * @param sqrtPrice - The AnchorDex's current sqrtPrice
 ...
 * @param slippageTolerance - The maximum slippage allowed when calculating the minimum tokens received.
 * @param whirlpool - A AnchorDex helper class to help interact with the AnchorDex account.
...
/**
 * @category Quotes
 * @param liquidity - The amount of liquidity value to deposit into the AnchorDex.
 * @param tokenMintA - The mint of tokenA in the AnchorDex the user is depositing into.
 * @param tokenMintB -The mint of tokenB in the AnchorDex the user is depositing into.
 * @param tickCurrentIndex - The AnchorDex's current tickIndex
 * @param sqrtPrice - The AnchorDex's current sqrtPrice
