...
/**
 * Program ID hosting Orca's AnchorDex program.
 * @category Constants
 */
...
/**
 * The maximum tick index supported by the AnchorDex program.
 * @category Constants
 */
export const MAX_TICK_INDEX = 443636;

/**
 * The minimum tick index supported by the AnchorDex program.
 * @category Constants
 */
export const MIN_TICK_INDEX = -443636;

/**
 * The maximum sqrt-price supported by the AnchorDex program.
 * @category Constants
 */
export const MAX_SQRT_PRICE = "79226673515401279992447579055";

/**
 * The minimum sqrt-price supported by the AnchorDex program.
 * @category Constants
 */
...
/**
 * The public key that is allowed to update the metadata of AnchorDex NFTs.
 * @category Constants
 */
